...
export default function MYDOPortal() {
  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-slate-900 transition-colors duration-300 flex flex-col overflow-hidden relative">
        ...
        <div className="flex items-center justify-end gap-4 flex-1 relative">
          ...
          <div className="relative w-72 group hidden md:block">
            ...
            <input
              type="text"
              placeholder="Search..."
              style={{ backgroundColor: isDarkMode ? "#1e293b" : "#e7f0fa" }}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right hidden lg:block">
              ...
              <p className="text-xs text-[#7BA4D0]">MYDO Administrator</p>
            </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* SIDEBAR */}
        <nav
          className={`pl-10 pr-4 py-2 space-y-2 transition-all duration-300 shrink-0 overflow-y-auto ${isSidebarShrinked ? "w-24" : "w-72"}`}
        >
          <button
          ...
          >
            ...
            {!isSidebarShrinked && (
              <span className="font-semibold text-sm">SK Profiles</span>
            )}
          </button>
          ...
          >
            ...
            {!isSidebarShrinked && (
              <span className="font-semibold text-sm">Brgy Map</span>
            )}
          </button>
        ...
        {/* MAIN AREA */}
        <main
          className={`flex-1 h-full pr-10 pb-10 pl-2 transition-all ${
            activeMenu === "map" || activeMenu === "reports"
              ? "overflow-hidden"
              : "overflow-y-auto"
          }`}
        >
